    ...
    <div class="opt-page">
        <div class="ss-card">
            ...
            <div class="opt-item">
                ...
                <div class="select-wrapper">
                    <select
                        v-model="runtimeData.sysConfig.auto_mark_read"
                        title="auto_mark_read"
                    >
                        <option value="viewer">
                            {{ $t('浏览+发消息时（默认）') }}
                        </option>
        ...
        <div class="ss-card">
            ...
            <div
                v-if="runtimeData.sysConfig.close_respond !== true"
                class="opt-item"
            >
                <div
                    :class="{
                ...
                <div class="select-wrapper">
                    <select
                        v-model="runtimeData.sysConfig.show_response_message"
                        name="show_response_message"
                        title="show_response_message"
                    >
                        <option value="none">
                            {{ $t('不通知') }}
                        </option>
        ...
        <div class="ss-card">
            ...
            <div class="opt-item">
                ...
                <input
                    v-model="runtimeData.sysConfig.msg_tail"
                    class="ss-input"
                    style="width: 150px"
                    type="text"
                    name="msg_taill"
            ...
            <div class="opt-item">
                ...
                <div class="select-wrapper">
                    <select
                        ...
                        "
                        v-model="runtimeData.sysConfig.send_key"
                        name="send_key"
                        title="send_key"
                    >
                        <option value="none">Enter</option>
                        <option value="shift">Shift + Enter (⇧)</option>
                        <option value="ctrl">Control + Enter (⌃)</option>
                        <option value="alt">Option + Enter (⌥)</option>
                        <option value="meta">Command + Enter (⌘)</option>
                    </select>
                    <select
                        v-else
                        v-model="runtimeData.sysConfig.send_key"
                    ...
                    >
                        ...
                        <option value="meta">Meta + Enter</option>
                    </select>
                </div>
            </div>
            <div class="opt-item">
            ...
            <div class="opt-item">
                ...
                <div>
                    <span>{{ $t('转发默认多选') }}</span>
                    <span>{{
                        $t('需要用到这个选项的...应该是和我一样的搬石大王吧？')
                    }}</span>
                </div>
                <Switch
                    v-model="runtimeData.sysConfig.default_multiselect_forward"
                />
            </div>
            <div class="opt-item">
                <div
                ...
                <div>
                    <span>{{ $t('回复消息插入@') }}</span>
                    <span>{{
                        $t('emm...回复消息没@好像挺另类的样子...')
                    }}</span>
                </div>
                <div class="select-wrapper">
                    <select
                        v-model="runtimeData.sysConfig.reply_with_at"
                        name="reply_with_at"
                        title="reply_with_at"
                    >
                        <option value="none">
        ...
        <div class="ss-card">
            ...
            <div v-if="runtimeData.sysConfig.close_ga !== true" class="tip">
                {{
                    $t(
                        '我们使用 Umami 对应用的使用情况进行分析，它将不会上传精确到用户的信息；你也可以在这儿控制分析功能的开关和额外分析项。',
                    )
                }}
            </div>
            <div
